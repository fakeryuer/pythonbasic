...
交互模块，对系统交互
'''
os.system('ls')     # 调用系统命令ls
# os.system('ipconfig')     # 调用系统命令ipconfig

# os.mkdir('C.txt')      # 创建文件、文件夹
# os.rename('A','B')          # 文件夹A重命名为B
print(os.path.abspath('C.txt'))        # 查看C文件路径，该例子只查找当前文件夹
print(os.path.join('mk1','mk2'))        # 拼接路径

# shutil 高级操作：移动、复制、删除
import shutil
# shutil.move('C.txt','../')  # 移动到上一个文件夹
shutil.rmtree('C.txt')     # 删除文件
# shutil.copy()
